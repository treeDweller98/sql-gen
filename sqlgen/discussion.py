...
class MultiAgentDiscussion:
    def discuss(
        ...
        output_path: Path, savename: str, batch_size: int, evaluator_fn: Callable
            ...
            starters_1 = starter.batched_generate(df, cfg, batch_size, 'starter1', evaluator_fn, persona='simple')
            starters_2 = starter.batched_generate(df, cfg, batch_size, 'starter2', evaluator_fn, persona='technical')
            starters_3 = starter.batched_generate(df, cfg, batch_size, 'starter3', evaluator_fn, persona='thinker')

            agent_1_discuss_r1 = agent_1.batched_generate(df, cfg, batch_size, f'agent_1_R{1}', evaluator_fn, agent_responses=gather_agent_responses(2, starters_2.raw_responses, 3, starters_3.raw_responses))
            agent_2_discuss_r1 = agent_2.batched_generate(df, cfg, batch_size, f'agent_2_R{1}', evaluator_fn, agent_responses=gather_agent_responses(1, starters_1.raw_responses, 3, starters_3.raw_responses))
            agent_3_discuss_r1 = agent_3.batched_generate(df, cfg, batch_size, f'agent_3_R{1}', evaluator_fn, agent_responses=gather_agent_responses(1, starters_1.raw_responses, 2, starters_2.raw_responses))
            
            agent_1_discuss_r2 = agent_1.batched_generate(df, cfg, batch_size, f'agent_1_R{2}', evaluator_fn, agent_responses=gather_agent_responses(2, agent_2_discuss_r1.raw_responses, 3, agent_3_discuss_r1.raw_responses))
            agent_2_discuss_r2 = agent_2.batched_generate(df, cfg, batch_size, f'agent_2_R{2}', evaluator_fn, agent_responses=gather_agent_responses(1, agent_1_discuss_r1.raw_responses, 3, agent_3_discuss_r1.raw_responses))
            agent_3_discuss_r2 = agent_3.batched_generate(df, cfg, batch_size, f'agent_3_R{2}', evaluator_fn, agent_responses=gather_agent_responses(1, agent_1_discuss_r1.raw_responses, 2, agent_2_discuss_r1.raw_responses))
            ...
            verdict = judge.batched_generate(df, cfg, batch_size, 'judge', evaluator_fn, agent_responses=gather_all_responses(agent_1_discuss_r2.raw_responses, agent_2_discuss_r2.raw_responses, agent_3_discuss_r2.raw_responses))
