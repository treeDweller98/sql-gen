...
class MultiAgentDiscussion(TextToSQL):
    def generate_zeroshot_starter(self, schema: str, question: str, hint: str, use_meta_prompt: bool) -> str:
        ...
        if use_meta_prompt:
            system_prompt = (
                "You are an SQLite expert who excels at writiing optimized SQL queries. "
                "You will be given a database schema and a question that you must answer "
                "by writing a valid SQLite query based on that schema. "
                ...
                "   - Decompose the question into actionable steps to ensure you have understood it.\n"
                ...
                "4. Ensure that your choices are correct and optimal.\n"
                "5. Show your reasoning and write down the final SQL query."
            )
            user_prompt = (
                f"### Schema:\n{schema}\n\n"
                f"### Question:\n{question} Hint: {hint}."
    ...
    def generate_discussion(self, schema: str, question: str, hint: str, agent_responses: dict[str, str]) -> str:
    ...
    def generate_verdict(self, schema: str, question: str, hint: str, agent_responses: dict[str, str]) -> str:
